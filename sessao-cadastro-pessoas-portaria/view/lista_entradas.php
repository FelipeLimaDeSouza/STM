			...
			<table class="table">
				...
				<tbody>
					...
					<?php
						...
						if((isset($_COOKIE['entradas_all'])) && ($_COOKIE['entradas_all'] == 1)){
							...
							echo "<tr><td colspan='11'><button class='buttons_alt' id='ver-menos-entradas' type='button'>Ver Menos</button></td></tr>";

						}else{

							echo "<tr><td colspan='11'><button class='buttons_alt' id='ver-mais-entradas' type='button'>Ver Mais</button></td></tr>";
