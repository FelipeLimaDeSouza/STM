...
<head>
	...
	<title>Cadastro de Pessoas | Lista de Funcionários</title>
...
<body>
	...
	<article>
		...
		<h1 class="h1">Funcionários Cadastrados</h1>
			...
			<table class="table">
				...
				<tbody>
					...
					<?php
						...
						$dados = $control->retornaFuncionarios();
					...
					<tr>
						...
						<td><?php echo $reg->funcionario_id; ?></td>
